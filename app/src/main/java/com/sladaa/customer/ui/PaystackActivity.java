...
//        PaystackSdk.setPublicKey("pk_test_71d15313379591407f0bf9786e695c2616eece54");
    ...
    private class verifyOnServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                if (result.equalsIgnoreCase("Transaction was successful")) {
                    ...
                    Toast.makeText(PaystackActivity.this, "" + result.toString(), Toast.LENGTH_LONG).show();
                }
            } else {
        ...
        protected String doInBackground(String... reference) {
            try {
                ...
                String url1 = APIClient.baseUrl + "/capi/p_verify.php?details=" + URLEncoder.encode(json, "UTF-8");
