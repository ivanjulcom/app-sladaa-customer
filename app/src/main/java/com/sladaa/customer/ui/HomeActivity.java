...
import com.sladaa.customer.fragment.CategoryFragment;
import com.sladaa.customer.fragment.HomeFragment;
import com.sladaa.customer.fragment.SubCategoryFragment;
import com.sladaa.customer.model.Pincode;
...
import com.sladaa.customer.utiles.Utility;
...
import static com.sladaa.customer.ui.SearchActivity.searchCategory;
...
import static com.sladaa.customer.utiles.SessionManager.storename;
...
public class HomeActivity extends RootActivity implements GetResult.MyListener {
    ...
    @BindView(R.id.pilih_toko)
    TextView txtpilihtoko;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!sessionManager.getBooleanData(SessionManager.login)) {
            ...
            finish();
        } else if(TextUtils.isEmpty(sessionManager.getStringData(type))){
            ...
            txtpilihtoko.setVisibility(View.VISIBLE);
            startActivity(new Intent(HomeActivity.this, StoreActivity.class));
        } else {
            txtpilihtoko.setVisibility(View.GONE);
    ...
    public void setLocation(String location) {
        txtpilihtoko.setVisibility(View.GONE);
        txtActiontitle.setText("" + location);
