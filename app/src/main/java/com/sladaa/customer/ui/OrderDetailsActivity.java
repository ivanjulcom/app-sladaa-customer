...
import com.sladaa.customer.model.OrderP;
import com.sladaa.customer.model.OrderProductDatum;
...
public class OrderDetailsActivity extends RootActivity implements GetResult.MyListener {
    ...
    public void orderTrackData() {
        ...
        txtTitel.setText("Lacak Pesanan");
        ...
        try {
            ...
            if (callNo.equalsIgnoreCase("1")) {
                ...
                if (orderP.getResult().equalsIgnoreCase("true")) {
                    ...
                    txtOrderDate.setText("" + parseDateToddMMyyyy(orderP.getOrderProductList().get(0).getOrderDate()));
                    ...
                    txtKupon.setText(sessionManager.getStringData(SessionManager.currency) + orderP.getOrderProductList().get(0).getKupon());
    ...
    private void setDataListItems(int a, String comment) {
        switch (a) {
            case 0:
                mDataList.add(new TimeLineModel("Menunggu keputusan toko", "", OrderStatus.ACTIVE));
                mDataList.add(new TimeLineModel("Diterima sedang mencari kurir", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Menunggu keputusan kurir", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Kurir menerima pesanan", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Kurir mengambil pesanan", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Pesanan selesai", "", OrderStatus.INACTIVE));
                break;
            case 1:
                mDataList.add(new TimeLineModel("Menunggu keputusan toko", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Diterima sedang mencari kurir", "", OrderStatus.ACTIVE));
                mDataList.add(new TimeLineModel("Dibatalkan oleh toko", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Menunggu keputusan kurir", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Kurir menerima pesanan", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Kurir mengambil pesanan", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Pesanan selesai", "", OrderStatus.INACTIVE));
            ...
            case 2:
                ...
                mDataList.add(new TimeLineModel("Dibatalkan oleh toko", comment, OrderStatus.ACTIVE));
                break;
            case 3:
                mDataList.add(new TimeLineModel("Menunggu keputusan toko", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Diterima sedang mencari kurir", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Menunggu keputusan kurir", "", OrderStatus.ACTIVE));
                mDataList.add(new TimeLineModel("Kurir menerima pesanan", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Diterima sedang mencari kurir", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Kurir mengambil pesanan", "", OrderStatus.INACTIVE));
                mDataList.add(new TimeLineModel("Pesanan selesai", "", OrderStatus.INACTIVE));
            ...
            case 4:
                mDataList.add(new TimeLineModel("Menunggu keputusan toko", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Diterima sedang mencari kurir", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Menunggu keputusan kurir", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Kurir menerima pesanan", "", OrderStatus.ACTIVE));
            ...
            case 6:
                ...
                mDataList.add(new TimeLineModel("Diterima sedang mencari kurir", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Menunggu keputusan kurir", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Kurir menerima pesanan", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Kurir mengambil pesanan", "", OrderStatus.ACTIVE));
                mDataList.add(new TimeLineModel("Pesanan selesai", "", OrderStatus.INACTIVE));
                break;
            case 7:
                mDataList.add(new TimeLineModel("Menunggu keputusan toko", "", OrderStatus.COMPLETED));
                ...
                mDataList.add(new TimeLineModel("Menunggu keputusan kurir", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Kurir menerima pesanan", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Kurir mengambil pesanan", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Pesanan selesai", "", OrderStatus.ACTIVE));
                break;
            case 8:
                mDataList.add(new TimeLineModel("Menunggu keputusan toko", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Dibatalkan oleh anda", "", OrderStatus.ACTIVE));
                break;
            case 9:
                mDataList.add(new TimeLineModel("Menunggu keputusan toko", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Diterima sedang mencari kurir", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Menunggu keputusan kurir", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Kurir menerima pesanan", "", OrderStatus.COMPLETED));
                mDataList.add(new TimeLineModel("Kurir membatalkan pesanan", comment, OrderStatus.ACTIVE));
                break;
            case 10:
                break;
            default:
