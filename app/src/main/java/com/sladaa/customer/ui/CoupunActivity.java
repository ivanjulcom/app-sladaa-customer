...
import com.sladaa.customer.adepter.CouponAdp;
import com.sladaa.customer.model.Coupon;
import com.sladaa.customer.model.Couponlist;
    ...
    public void onClickItem(View v, Couponlist coupon) {
        try {
            if (coupon.getMinAmt() < amount) {
                ...
                Toast.makeText(CoupunActivity.this, "Maaf kode kupon ini tidak berlaku!", Toast.LENGTH_LONG).show();
            }
        } catch (Exception e) {
            e.printStackTrace();
