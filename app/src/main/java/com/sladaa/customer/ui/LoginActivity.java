...
import com.sladaa.customer.model.Codes;
import com.sladaa.customer.model.CountryCode;
import com.sladaa.customer.model.Login;
import com.sladaa.customer.model.Register;
...
public class LoginActivity extends RootActivity implements GetResult.MyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sourceString = "Sudah Punya Akun <b>" + "Email/Password" + "</b> " + "?";
        String sourceCreate = "<b>Daftar?</b>";
            ...
            case R.id.btn_proceed:
                if (isNewuser) {
                    if (!TextUtils.isEmpty(edMobile.getText().toString())) {
                        ...
                        edMobile.setError("Masukan No. Telepon");
                    }
                } else {
                    if (TextUtils.isEmpty(edEmail.getText().toString())) {
                        edEmail.setError("Masukan No. Telepon / Email");
