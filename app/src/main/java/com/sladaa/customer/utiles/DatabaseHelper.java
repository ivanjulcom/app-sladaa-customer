package com.sladaa.customer.utiles;
...
import static com.sladaa.customer.ui.HomeActivity.txtCountcard;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertData(MyCart rModel) {
        ...
        if(Integer.parseInt(rModel.getQty())<=Integer.parseInt(sessionManager.getStringData(itemlimit))){
            ...
            Toast.makeText(mContext,"Melebihi batas pesanan!",Toast.LENGTH_SHORT).show();
            return false;
        }
