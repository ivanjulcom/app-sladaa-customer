...
public class HomeData {
    ...
    private List<HomeDatum> homeDatumList;
    ...
    public List<HomeDatum> getHomeDatumList() {
        return homeDatumList;
    }

    public void setHomeDatumList(List<HomeDatum> homeDatumList) {
        this.homeDatumList = homeDatumList;
    }
}
