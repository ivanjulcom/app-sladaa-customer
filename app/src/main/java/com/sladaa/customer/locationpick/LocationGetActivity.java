package com.sladaa.customer.locationpick;
...
//    TextView txtCity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (i != null) {
            ...
            if (extras != null) {
                ...
                if (atype.equalsIgnoreCase("Rumah")) {
                    txtHome.performClick();
                } else if (atype.equalsIgnoreCase("Kantor")) {
                    txtOffice.performClick();
                } else if (atype.equalsIgnoreCase("Lainnya")) {
    ...
    public boolean validation() {
        if (edHoseno.getText().toString().isEmpty()) {
            edHoseno.setError("Masukan No. rumah ");
            return false;
        }
        if (edLandmark.getText().toString().isEmpty()) {
            edLandmark.setError("Masukan landmark");
            return false;
        }
        return true;
    }
