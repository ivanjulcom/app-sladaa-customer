...
public class CouponAdp extends RecyclerView.Adapter<CouponAdp.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        makeTextViewResizable(holder.txtDesc, 3, "Lihat lebih banyak", true);
            ...
            ssb.setSpan(new MySpannable(false){
                ...
                public void onClick(View widget) {
                    if (viewMore) {
                        ...
                        tv.invalidate();
                        makeTextViewResizable(tv, -1, "Lihat lebih sedikit", false);
                    } else {
                        tv.setLayoutParams(tv.getLayoutParams());
                        tv.setText(tv.getTag().toString(), TextView.BufferType.SPANNABLE);
                        tv.invalidate();
                        makeTextViewResizable(tv, 3, ".. Lihat lebih banyak", true);
                    }
                }
