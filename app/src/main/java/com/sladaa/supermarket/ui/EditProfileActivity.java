...
import com.sladaa.supermarket.model.ProfileUpdate;
...
public class EditProfileActivity extends RootActivity implements GetResult.MyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edMobile.setText("0"+user.getMobile());
    ...
    public boolean validation() {
        if (edFirstName.getText().toString().isEmpty()) {
            edFirstName.setError("Masukan nama depan");
            return false;
        }
        if (edLastName.getText().toString().isEmpty()) {
            edLastName.setError("Masukan nama belakang");
            return false;
        }
