...
import static com.sladaa.supermarket.utiles.Utility.isvarification;
public class VerifyPhoneActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtMob.setText("Masukan 6 digit kode yang dikirimkan \nke " + phonecode + " " + phonenumber);
        try {
            new CountDownTimer(60000, 1000) {
                @Override
                public void onTick(long millisUntilFinished) {
                    long seconds = TimeUnit.MILLISECONDS.toSeconds(millisUntilFinished);
                    btnTimer.setText(seconds + " Detik Menunggu");
                }
    ...
    private void verifyCode(String code) {
       ...
       // signInWithCredential(credential);
        try {
            ...
            Toast toast = Toast.makeText(getApplicationContext(), "Kode salah, mohon coba lagi!", Toast.LENGTH_SHORT);
